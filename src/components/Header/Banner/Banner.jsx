  ...
  return (
    <div className="md:h-[70vh] h-[50vh]  bg-[url('./src/assets/bannerImg.jpeg')] bg-cover bg-center bg-no-repeat bg-blend-lighten bg-white bg-opacity-90 flex justify-center items-center">
      <div className=" mt-28 md:mt-0">
        ...
        <input type="text"  className="py-3 md:w-96 rounded-s-lg outline-none p-4 focus:drop-shadow-2xl shadow bg-white border-2  ease-in duration-100" placeholder="Search here...."/>
        <button className="bg-[#FF444A] py-3 rounded-e-lg px-6 font-bold ease-out duration-100 hover:scale-105  text-white shadow-md border-2 border-[#FF444A]">Search</button>
        </div>
      </div>
    </div>
  )
