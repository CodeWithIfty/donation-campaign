...
const Banner = () => {
  return (
    <div className="md:h-[70vh] h-[50vh]  bg-[url('https://i.ibb.co/s1nc18r/banner-Img.jpg')] bg-cover bg-center bg-no-repeat bg-blend-lighten bg-white bg-opacity-90 flex justify-center items-center">
